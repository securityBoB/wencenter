<?php
/* Smarty version 3.1.29, created on 2016-06-03 16:42:40
  from "F:\mywamp\Apache24\htdocs\QandA\application\front\view\user\register.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_575143005286d6_61529734',
  'file_dependency' => 
  array (
    '0195306b8ef275f1cc354d810b4dcca94c03212f' => 
    array (
      0 => 'F:\\mywamp\\Apache24\\htdocs\\QandA\\application\\front\\view\\user\\register.html',
      1 => 1464943358,
      2 => 'file',
    ),
  ),
...
function content_575143005286d6_61529734 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
...
<link type="text/css" rel="stylesheet" href="<?php echo @constant('ROOT');?>
web/front/css/default/register.css?v=20151125">
...
web/front/css/default/img/login_logo.png"></a>
		<h1>注册新用户</h1>
	</div>
	<div class="mod-body">
		<form id="register_form" method="post" action="<?php echo framework\core\Factory::U('front/User/registerProcess',array());?>
" class="aw-register-form">
			<ul>
				...
				<li>
				<li>
					<input type="text" value="" tips="" placeholder="昵称，用于展示" name="user_nickname" class="aw-register-name form-control">
				</li>
				<li>
				...
				<li>
					<input type="password" errortips="密码不符合规则" tips="请输入 6-16 个字符,区分大小写" placeholder="密码" name="user_password" class="aw-register-pwd form-control"></li>
				...
				<li class="aw-register-verify">
					<img src="<?php echo framework\core\Factory::U('front/User/captcha');?>
" onclick=" 
					this.src='<?php echo framework\core\Factory::U('front/User/captcha');?>
'+Math.random()"
					id="captcha" class="pull-right">
				...
				<li class="last">
					...
					<a class="pull-right" href="<?php echo framework\core\Factory::U('front/User/login');?>
">已有账号?</a>
